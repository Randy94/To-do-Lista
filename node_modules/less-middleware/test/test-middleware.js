...
describe('middleware', function(){
  describe('simple', function(){
    ...
    it('should process simple less files', function(done){
      var expected = fs.readFileSync(__dirname + '/fixtures/simple-exp.public', 'utf8');
      request(app)
        .get('/simple.public')
        .expect(200)
  ...
  describe('source map', function(){
    ...
    it('should handle source map files', function(done){
      var expected = fs.readFileSync(__dirname + '/fixtures/simple-exp.public.map', 'utf8');
      request(app)
        .get('/simple.public.map')
        .expect(200)
        .expect(expected, done);
    });
  });
  ...
  describe('import', function(){
    ...
    it('should process less files with imports', function(done){
      var expected = fs.readFileSync(__dirname + '/fixtures/importSimple-exp.public', 'utf8');
      request(app)
        .get('/importSimple.public')
        .expect(200)
        .expect(expected, done);
    });

    it('should process less files with nested imports', function(done){
      var expected = fs.readFileSync(__dirname + '/fixtures/import-exp.public', 'utf8');
      request(app)
        .get('/import.public')
        .expect(200)
        .expect(expected, done);
  ...
  describe('options', function(){
    describe('postprocess', function(){
      describe('css', function(){
        ...
        it('should prepend the comment on all output public', function(done){
          var expected = fs.readFileSync(__dirname + '/fixtures/postprocessCss-exp.public', 'utf8');
          request(app)
            .get('/postprocessCss.public')
            .expect(200)
            .expect(expected, done);
        });
      });
    ...
    describe('preprocess', function(){
      describe('less', function(){
        ...
        it('should add namespace when found', function(done){
          var expected = fs.readFileSync(__dirname + '/fixtures/preprocessLess-exp-a.public', 'utf8');
          clearCache('preprocessLess.public');
          request(app)
            .get('/preprocessLess.public?namespace=h1')
            .expect(200)
            .expect(expected, done);
        });

        it('should not add namespace when none provided', function(done){
          var expected = fs.readFileSync(__dirname + '/fixtures/preprocessLess-exp-b.public', 'utf8');
          clearCache('preprocessLess.public');
          request(app)
            .get('/preprocessLess.public')
            .expect(200)
            .expect(expected, done);
        });
      });
      ...
      describe('path', function(){
        ...
        it('should remove .ltr from the less path when found', function(done){
          var expected = fs.readFileSync(__dirname + '/fixtures/preprocessPath-exp.public', 'utf8');
          request(app)
            .get('/preprocessPath.ltr.public')
            .expect(200)
            .expect(expected, done);
        });
      ...
      describe('importPaths', function(){
        ...
        it('should respond with newly mapped paths', function(done){
          var expected = fs.readFileSync(__dirname + '/fixtures/preprocessParserPaths-exp.public', 'utf8');
          request(app)
            .get('/2.43.3/preprocessParserPaths.public')
            .expect(200)
            .expect(expected, done);
        });
      });
      ...
      describe('pathRoot', function(){
        ...
        it('should process simple less files', function(done){
          var expected = fs.readFileSync(__dirname + '/fixtures/pathRoot-exp.public', 'utf8');
          request(app)
            .get('/pathRoot.public')
            .expect(200)
            .expect(expected, done);
