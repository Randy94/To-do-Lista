...
var testFiles = ['charsets', 'colors', 'comments', 'public-3', 'strings', 'media', 'mixins'],
    testSheets = [];
...
// setup style tags with less and link tags pointing to expected public output

for (var i = 0; i < testFiles.length; i++) {
    var file = testFiles[i],
        lessPath  = '/test/less/' + file + '.less',
        cssPath   = '/test/public/' + file + '.public',
