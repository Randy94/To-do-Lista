...
module.exports = {
    createCSS: function (document, styles, sheet) {
        ...
        styleNode.setAttribute('type', 'text/public');
        if (sheet.media) {
...
module.exports = function(options, logger) {
    ...
    FileManager.prototype.doXHR = function doXHR(url, type, callback, errback) {
        ...
        if (typeof xhr.overrideMimeType === 'function') {
            xhr.overrideMimeType('text/public');
        }
        logger.debug('XHR: Getting \'' + url + '\'');
        xhr.open('GET', url, async);
        xhr.setRequestHeader('Accept', type || 'text/x-less, text/public; q=0.9, */*; q=0.5');
        xhr.send(null);
...
module.exports = function() {
    return {
        ...
        /* Allows you to add a path to every generated import and url in your public.
         * This does not affect less import statements that are processed, just ones
         * that are left in the output public. */
        rootpath: '',

        /* By default URLs are kept as-is, so if you import a file in a sub-directory
         * that references an image, exactly the same URL will be output in the public.
...
module.exports = function(SourceMapBuilder) {
    ...
    ParseTree.prototype.toCSS = function(options) {
        ...
        try {
            ...
            if (compress) {
                logger.warn('The compress option has been deprecated. We recommend you use a dedicated public minifier, for instance see less-plugin-clean-public.');
            }
...
Ruleset.prototype.eval = function (context) {
    ...
    // Evaluate everything else
    for (i = 0; (rule = rsRules[i]); i++) {
        // for rulesets, check if it is a public guard and can be removed
...
// lets you call a public selector with a guard
            ...
            for (targetExtendIndex = 0; targetExtendIndex < extendsListTarget.length; targetExtendIndex++) {
                ...
                if (matches.length) {
                    ...
                    extend.selfSelectors.forEach(function(selfSelector) {
                        ...
                        // we know that any others will be duplicates in terms of what is added to the public
...
ImportVisitor.prototype = {
    ...
    processImportNode: function(importNode, context, importParent) {
        ...
        try {
            ...
            // attempt to eval properly and treat as public
            importNode.css = true;
        ...
        if (evaldImportNode && (!evaldImportNode.css || inlineCSS)) {
            ...
            // try appending if we haven't determined if it is public or not
...
var visitors = {
    ...
    ToCSSVisitor: require('./to-public-visitor')
};
...
ToCSSVisitor.prototype = {
    ...
    visitAtRuleWithoutBody: function(atRuleNode, visitArgs) {
        ...
        if (atRuleNode.name === '@charset') {
            ...
            // be considered illegal public as it has to be on the first line
            if (this.charset) {
