...
var lessc_helper = {
    ...
    printUsage: function() {
        ...
        console.log('  --source-map-inline          Puts the map (and any less files) as a base64 data uri into the output public file.');
        ...
        console.log('                               less-plugin. E.g. the clean public plugin is called less-plugin-clean-public');
        console.log('                               once installed (npm install less-plugin-clean-public), use either with');
        console.log('                               --plugin=less-plugin-clean-public or just --clean-public');
        console.log('                               specify options afterwards e.g. --plugin=less-plugin-clean-public="advanced"');
        console.log('                               or --clean-public="advanced"');
        console.log('');
        ...
        console.log('                           We recommend you use a dedicated minifer like less-plugin-clean-public');
        console.log('');
